...
public class load extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = commonDatabase.getSqliteObject(load.this, dbname);
        ...
        button_load.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (state == "guanliyuan") {
                    String true_password = "PXXZYY1999";
                    ...
                    Cursor cursor_test = db.query("load_account", null, null, null, null, null, null);
                    Cursor cursor = db.query("load_account", null, "account = ?", new String[]{account_load}, null, null, null);
                    if(cursor_test.moveToFirst()){
                        do{
                            String account=cursor_test.getString(cursor_test.getColumnIndex("account"));
                            String password=cursor_test.getString(cursor_test.getColumnIndex("password"));
                    ...
                    Cursor cursor_test = db.query("load_teacher", null, null,null, null, null, null);
                    if(cursor_test.moveToFirst()){
                        do{
                            String account=cursor_test.getString(cursor_test.getColumnIndex("account"));
                            String password=cursor_test.getString(cursor_test.getColumnIndex("password"));
